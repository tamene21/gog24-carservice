...
const Footer = () => {
  return (
    <footer className="bg-[#252424] text-center text-white dark:bg-[#252424] dark:text-neutral-200 lg:text-left">
      ...
      {/* <!--Copyright section-->*/}
      <div className="bg-neutral-600 p-2 text-left dark:bg-neutral-700">
        <span>© 2023 Copyright 2023 By gog24:All rights reserved</span>
        <a
